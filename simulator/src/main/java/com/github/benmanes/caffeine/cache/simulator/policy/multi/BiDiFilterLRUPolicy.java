 ...
 */
@PolicySpec(name = "multi.BiDiFilterLRU")
public final class BiDiFilterLRUPolicy implements KeyOnlyPolicy {
  ...
  public BiDiFilterLRUPolicy(WindowTinyLfuSettings settings) {
    ...
    this.maxWindow = maximumSizeFirst;
  ...
  public static Set<Policy> policies(Config config) {
    ...
    return ImmutableSet.of(new BiDiFilterLRUPolicy(settings));
  }
  ...
  private boolean promote(Node node) {
    Node victim = headWindow.next;
    if (victim == headWindow) {
      return false;
    }
